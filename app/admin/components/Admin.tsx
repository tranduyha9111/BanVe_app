            ...
            <SidebarMenu className="flex w-full min-w-0 flex-col gap-1">
              ...
              <SidebarMenuItem className="group/menu-item relative">
                <SidebarMenuButton
                  ...
                  asChild
                >
                  <Link href="/admin/contentstats">
                    <BarChart3 className="lucide lucide-bar-chart-3" />
              ...
              <SidebarMenuItem className="group/menu-item relative">
                ...
                >
                  <Link href="/admin/coupons">
                    <Ticket className="lucide lucide-ticket" />
              ...
              <SidebarMenuItem className="group/menu-item relative">
                ...
                >
                  <Link href="/admin/withdrawals">
                    <DollarSign className="lucide lucide-dollar-sign" />
                    <span> Rút tiền</span>
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem className="group/menu-item relative">
                ...
                >
                  <Link href="/admin/reviews">
                    <MessageSquare className="lucide lucide-message-square" />
                    <span> Đánh giá</span>
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem className="group/menu-item relative">
                <SidebarMenuButton
                  ...
                  asChild
                >
                  <Link href="/admin/copyrightreports">
                    <Shield className="lucide lucide-shield" />
                    <span> Báo cáo bản quyền</span>
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem className="group/menu-item relative">
                ...
                >
                  <Link href="/admin/users">
                    <Users className="lucide lucide-users" />
                ...
                <Collapsible>
                  ...
                  <CollapsibleContent className="CollapsibleContent">
                    <SidebarMenuSub className="border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0.5 group-data-[collapsible=icon]:hidden">
                      ...
                      <SidebarMenuSubItem className="group/menu-sub-item relative">
                        <SidebarMenuSubButton href="/admin/settings/account">
                          <span>Tai khoan</span>
                        </SidebarMenuSubButton>
                      </SidebarMenuSubItem>
                    </SidebarMenuSub>
